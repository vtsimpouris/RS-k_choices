...
class Builder {
 public:
  ...
  int checkCDF(KeyType key) {
    return checkCDF(key, prev_position_ + 1);
  }
...
int checkCDF(KeyType key, double position) {
